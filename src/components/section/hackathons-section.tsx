...
const copy = {
  zh: {
    ...
    description: (count: number) =>
      `在大学期间，我参加过 ${count}+ 场黑客松。2-3 天里，来自不同背景的人一起做出很酷的产品，这种高强度协作让我看到创造力的上限。`,
  },
  en: {
    badge: "Hackathons",
    title: "I like building things",
    description: (count: number) =>
      `During my time in university, I attended ${count}+ hackathons. People from around the country came together to build incredible things in 2-3 days. It was eye-opening to see what motivated teams could ship that fast.`,
  },
} as const;
        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            ...
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              {text.description(hackathons.length)}
            </p>
          </div>
        </div>
        <Timeline>
